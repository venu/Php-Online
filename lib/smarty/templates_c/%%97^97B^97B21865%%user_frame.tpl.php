<?php /* Smarty version 2.6.14, created on 2012-04-27 14:06:55
...
">PHP Online editor</a></h2>
    ...
    <div align="center" class="fr"> <a href="#."> <img id="image" src="https://graph.facebook.com/<?php echo $_SESSION['user']['fb_id']; ?>
/picture?type=square"/> <span id="name"><?php echo $_SESSION['user']['name']; ?>
</span> </a>
...
window.fbAsyncInit = function() {
	FB.init({
		appId      : '<?php echo $this->_tpl_vars['CONF']['FB_APP_ID']; ?>
',
		status     : true, 
		cookie     : true,
		xfbml      : true,
